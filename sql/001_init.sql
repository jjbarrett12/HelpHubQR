-- HelpHubQR MVP schema (plan-aligned)
-- Run with Supabase migrations or standalone.
...
-- 9) task_events (immutable audit log)
...
-- Optional: supervisor profile (link auth.users to property for RLS)
...
create index idx_supervisor_profiles_property on public.supervisor_profiles(property_id);
